...
.PHONY: test
test: check-vendored-crds helm-test expect-fail-test kubeconform-test rbac-summary-check
...
.PHONY: rbac-summary
rbac-summary:
	python3 scripts/rbac_summary.py --write

.PHONY: rbac-summary-check
rbac-summary-check:
	python3 scripts/rbac_summary.py --check
